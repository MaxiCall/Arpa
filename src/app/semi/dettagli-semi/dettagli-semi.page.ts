...
@Component({
  ...
  standalone: true,
  imports: [
    IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonItem, IonIcon, IonLabel, IonMenuButton,
    CommonModule
  ]
})
export class DettagliSemiPage implements OnInit {
  ...
  goToMappaSemi(semillaId: string) {
    this.router.navigate(['/mappa-semi', semillaId]);
  }
